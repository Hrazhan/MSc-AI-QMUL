...
with torch.no_grad():
    ...
    SR_img = output_.squeeze(0).squeeze(0).numpy()
...
iio.imsave("./image/LR_image.jpg", LR_image)
# iio.imsave("./image/GT_image.jpg", HR_image)
iio.imsave("./image/SR_img.jpg", SR_img)
...
psnr = peak_signal_noise_ratio(HR_image, SR_img) # 22.9226
# psnr = peak_signal_noise_ratio(HR_image, LR_image) # 20.4976
# print(psnr)
