...
import static players.groupAU.utils.ConstantsGroupAU.*;
import static players.groupAU.utils.Utilities.index_ind_in_pop;
...
class Selection {
    ...
    Selection(RHEAParamsGroupAU params, Random random) {
        this.params = params;
        this.random = random;
    }
    ...
    public static void main(String[] args) {
        RHEAParamsGroupAU params = new RHEAParamsGroupAU();
