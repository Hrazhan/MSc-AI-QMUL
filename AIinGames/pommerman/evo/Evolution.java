package players.groupAU.evo;

import players.groupAU.GameInterface;
...
public class Evolution {
    ...
    public Evolution(RHEAParamsGroupAU params, Random random, GameInterface gInterface) {
        this.params = params;
        this.random = random;
...
//        System.out.println(Arrays.toString(population));
    ...
    private Individual[] generate_offspring() {
        ...
        for (int i = 0; i < params.offspring_count; i++) {
            // if the population size is less than two, we can't do cross over, becuase you can't crossover one individual with itself
    ...
    private void combine_and_sort_population(Individual[] offspring){
        ...
        // experiment with this chunk of code a lot
